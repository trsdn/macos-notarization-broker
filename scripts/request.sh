...
case "$app" in
  better-kampfinsel|md2loop|openconnct|opendefendrwatchr|openlens|openswitchr|openwritr|printfilemanager|ptionsplus|spacemender|teleprompter|threemfquicklook) ;;
  *)
    echo "Usage: $0 {better-kampfinsel|md2loop|openconnct|opendefendrwatchr|openlens|openswitchr|openwritr|printfilemanager|ptionsplus|spacemender|teleprompter|threemfquicklook} vX.Y.Z [output-directory]" >&2
    exit 1
    ;;
esac
