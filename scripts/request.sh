...
case "$app" in
  md2loop|openconnct|opendefendrwatchr|openlens|openwritr|ptionsplus|spacemender|teleprompter) ;;
  *)
    echo "Usage: $0 {md2loop|openconnct|opendefendrwatchr|openlens|openwritr|ptionsplus|spacemender|teleprompter} vX.Y.Z [output-directory]" >&2
    exit 1
    ;;
esac
